...
> 🌟 如果对您的研究有帮助，欢迎 Star！
> 
> 📝 对应论文：[面向海洋智能的水下视觉数据集综述]/[A survey of underwater visual datasets for ocean intelligence]
...
- [水下目标检测数据集](#水下目标检测数据集)
- [水下语义分割数据集](#水下语义分割数据集)
- [水下图像实例分割与显著性/伪装目标检测数据集](#水下图像实例分割与显著性伪装目标检测数据集)
- [水下目标跟踪数据集](#水下目标跟踪数据集)
- [水下三维重建数据集](#水下三维重建数据集)
- [如何贡献](#如何贡献)
...
## 水下图像实例分割与显著性/伪装目标检测数据集

### 表 5：水下图像实例分割与显著性/伪装目标检测数据集总结
